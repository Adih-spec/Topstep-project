      ...
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          ...
          <ul class="list-inline d-inline">
            <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-color" href="about.html#"><i class="ti-facebook"></i></a></li>
            <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-color" href="about.html#"><i class="ti-twitter-alt"></i></a></li>
            <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-color" href="about.html#"><i class="ti-linkedin"></i></a></li>
            <li class="list-inline-item mx-0"><a class="d-inline-block p-2 text-color" href="about.html#"><i class="ti-instagram"></i></a></li>
          </ul>
        </div>
        <div class="col-lg-8 text-center text-lg-right">
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="about.html#" data-toggle="modal" data-target="#loginModal">login</a></li>
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="about.html#" data-toggle="modal" data-target="#signupModal">register</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item dropdown view">
              <a class="nav-link dropdown-toggle" href="about.html#" id="navbarDropdown" role="button" data-toggle="dropdown"
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <h2 class="section-title">ABOUT TOPSTEPS SCHOOL ACADEMY</h2>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
          ...
          <ul class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="about.html#">Forums</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">Documentation</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">Language</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">Release Status</a></li>
          </ul>
        </div>
        <!-- support -->
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
          ...
          <ul class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="about.html#">WordPress</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">LearnPress</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">WooCommerce</a></li>
            <li class="mb-3"><a class="text-color" href="about.html#">bbPress</a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-5 text-sm-right text-center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a class="d-inline-block p-2" href="about.html#"><i class="ti-instagram text-primary"></i></a></li>
