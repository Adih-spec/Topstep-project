        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
                    <h4 class="text-white mb-5">Topsteps Academy</h4>
                    <ul class="list-unstyled">
            ...
            <div class="row">
                <div class="col-sm-7 text-sm-left text-center">
                    <p class="mb-0">Copyright
                        ...
                        © Theme By <a href="#">Elite Tech Dev</a>. All Rights Reserved.
                    </p>
                </div>
...
<!-- /Footer -->
<script src="{{ asset('MainAssets/plugins/jQuery/jquery.min.js') }}"></script>
<!-- Bootstrap JS -->
<script src="{{ asset('MainAssets/plugins/bootstrap/bootstrap.min.js') }}"></script>
<!-- slick slider -->
<script src="{{ asset('MainAssets/plugins/slick/slick.min.js') }}"></script>
<!-- aos -->
<script src="{{ asset('MainAssets/plugins/aos/aos.js') }}"></script>
<!-- venobox popup -->
<script src="{{ asset('MainAssets/plugins/venobox/venobox.min.js') }}"></script>
<!-- mixitup filter -->
<script src="{{ asset('MainAssets/plugins/mixitup/mixitup.min.js') }}"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places"></script>
<script src="{{ asset('MainAssets/plugins/google-map/gmap.js') }}"></script>
