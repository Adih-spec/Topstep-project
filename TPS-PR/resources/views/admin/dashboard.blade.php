		...
		<div class="page-wrapper">
			<div class="content">
								...
								<div class="event-wrapper event-scroll">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-01.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-07.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-02.jpg" class="rounded-circle"
														alt="img">
												</span>
											</div>
										</div>
									...
									<div class="border-start border-info border-3 shadow-sm p-3 mb-3">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-05.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-06.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-07.jpg" class="rounded-circle"
									...
									<div class="border-start border-danger border-3 shadow-sm p-3 mb-3">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-11.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/parents/parent-13.jpg" class="rounded-circle"
														alt="img">
												</span>
											</div>
										</div>
								...
								<div class="tab-content">
									<div class="tab-pane fade active show" id="students">
										...
										<div class="text-center">
											...
											<a href="https://preskool.dreamstechnologies.com/html/template/student-attendance.html" class="btn btn-light"><i
									...
									<div class="tab-pane fade" id="teachers">
										...
										<div class="text-center">
											...
											<a href="https://preskool.dreamstechnologies.com/html/template/teacher-attendance.html" class="btn btn-light"><i
													class="ti ti-calendar-share me-1"></i>View All</a>
										</div>
									</div>
									<div class="tab-pane fade" id="staff">
										...
										<div class="text-center">
											...
											<a href="https://preskool.dreamstechnologies.com/html/template/staff-attendance.html" class="btn btn-light"><i
													class="ti ti-calendar-share me-1"></i>View All</a>
										</div>
									</div>
								</div>
									...
									<div class="owl-carousel student-slider h-100">
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/performer/performer-01.png" alt="img">
											</div>
										</div>
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/performer/performer-02.png" alt="img">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="owl-carousel teacher-slider h-100">
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/performer/student-performer-01.png" alt="img">
											</div>
										</div>
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/performer/student-performer-02.png" alt="img">
											</div>
										</div>
									</div>
								</div>
						...
						<div class="card flex-fill">
							...
							<div class="card-body pb-1">
								<div class="owl-carousel link-slider">
									...
									<div class="item">
										<a href="https://preskool.dreamstechnologies.com/html/template/student-attendance.html"
										...
										<a href="https://preskool.dreamstechnologies.com/html/template/attendance-report.html"
							...
							<div class="card-body">
								<div class="d-flex align-items-center rounded border p-3 mb-3">
									<span class="avatar avatar-md flex-shrink-0 border rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/teachers/teacher-01.jpg" class="rounded" alt="Profile">
									</span>
									<div class="w-100">
								...
								<div class="d-flex align-items-center rounded border p-3 mb-3">
									<span class="avatar avatar-md flex-shrink-0 border rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/teachers/teacher-02.jpg" class="rounded" alt="Profile">
									</span>
									<div class="w-100">
								...
								<div class="d-flex align-items-center rounded border p-3 mb-0">
									<span class="avatar avatar-md flex-shrink-0 border rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/teachers/teacher-03.jpg" class="rounded" alt="Profile">
									</span>
									<div class="w-100">
										<p class="mb-1">Oct 2024</p>
										<div class="progress progress-xs  flex-grow-1 mb-1">
										...
										<div class="d-flex align-items-center justify-content-between mb-3">
											<div class="d-flex align-items-center overflow-hidden me-2">
												<a href="javascript:void(0);"
													...
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/profiles/avatar-14.jpg" alt="student">
												</a>
									...
									<div class="card-body p-3">
										<div class="d-flex align-items-center justify-content-between mb-3">
											<div class="d-flex align-items-center overflow-hidden me-2">
												<a href="javascript:void(0);"
													class="avatar avatar-lg flex-shrink-0 me-2">
													<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/profiles/avatar-19.jpg" alt="student">
												</a>
												<div class="overflow-hidden">
													<h6 class="mb-1 text-truncate "><a
				...
				<div class="row">
					...
					<!-- Links -->
					<div class="col-xl-3 col-md-6 d-flex">
						<a href="https://preskool.dreamstechnologies.com/html/template/events.html"
					...
					<!-- Links -->
					<div class="col-xl-3 col-md-6 d-flex">
						<a href="https://preskool.dreamstechnologies.com/html/template/membership-plans.html"
							...
							<div class="card-body">
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/students/student-09.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/students/student-12.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/students/student-11.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-0 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="https://preskool.dreamstechnologies.com/html/template/assets/img/students/student-10.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
