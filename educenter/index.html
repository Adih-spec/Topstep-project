    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          <a class="text-color mr-3" href="callto: +234 915 074 1266"><strong>CALL</strong> +234 915 074 1266</a>
    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light p-0 align-items-center">
        <a class="navbar-brand d-flex align-items-center" href="index.html" style="padding: 0;">
          <img src="images/tps-logo.png" alt="logo" style="height: 100px; width: auto; max-width: 200px; object-fit: contain; display: block;">
        </a>
      ...
      <div class="row">
        ...
        <div class="col-sm-5 text-sm-right text-center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a class="d-inline-block p-2" href="index.html#"><i class="ti-instagram text-primary"></i></a></li>
